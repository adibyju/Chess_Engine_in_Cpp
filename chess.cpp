...
void load_images()
{
    background_img = al_load_bitmap("board.png");
    icon_img = al_load_bitmap("icon.png");

    std::cout<< "Loading images..." << std::endl;
    std::string s="";
    std::getline(std::cin, s);

    white_pawn_img = al_load_bitmap("white_pawn.png");
    white_knight_img = al_load_bitmap("white_knight.png");
    white_bishop_img = al_load_bitmap("white_bishop.png");
    white_rook_img = al_load_bitmap("white_rook.png");
    white_queen_img = al_load_bitmap("white_queen.png");
    white_king_img = al_load_bitmap("white_king.png");
    black_pawn_img = al_load_bitmap("black_pawn.png");
    black_knight_img = al_load_bitmap("black_knight.png");
    black_bishop_img = al_load_bitmap("black_bishop.png");
    black_rook_img = al_load_bitmap("black_rook.png");
    black_queen_img = al_load_bitmap("black_queen.png");
    black_king_img = al_load_bitmap("black_king.png");

    if(!black_king_img) std::cout<<"Images not found"<<std::endl;
}
